 ...
 * @author Solan
 */
public class IngresarProfesoresPlantaController implements Initializable {
    ...
    public IngresarProfesoresPlantaController() {
    ...
    void agregarDocente(ActionEvent event) {
        ...
        txtSalario.getText().isEmpty() || txtPuntosSalariales.getText().isEmpty() || txtValorPunto.getText().isEmpty())){
            ...
            u.ingresarProfesores(cmbDepartamento.getValue(), "Planta", txtCodigo.getText(), txtNombre.getText(), txtTitulo.getText(), 0, 0, 0,
